...
import com.lph.database.InterfaceDAO;
import com.lph.datebase.util.HibernateUtil;
...
public abstract class GenericDAO<T, PK extends Serializable> implements InterfaceDAO<T, PK> {
	...
	public T save(T x) throws HibernateException, SQLException, ClassNotFoundException {        
	...
	public void update(T x) throws HibernateException, SQLException, ClassNotFoundException {
		Session sessao = getSession();
	...
	public void delete(T x) throws HibernateException, SQLException, ClassNotFoundException {
		Session sessao = getSession();
	...
	@SuppressWarnings("unchecked")
	public List<T> listAll() throws HibernateException, SQLException, ClassNotFoundException {
